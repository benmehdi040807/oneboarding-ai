...
const T: Record<Lang, any> = {
  fr: {
    ...
    INFO: "Nous vérifions votre espace et votre appareil. Si c’est un nouvel appareil, nous vous proposerons une autorisation à 1 €.",
    CANCEL: "Annuler",
    CONTINUE: "Continuer",
    REVOKE_HINT:
  ...
  en: {
    ...
    INFO: "We’ll check your space and device. If this is a new device, we’ll propose a €1 authorization.",
    CANCEL: "Cancel",
    CONTINUE: "Continue",
    REVOKE_HINT:
  ...
  ar: {
    ...
    INFO: "سنتحقق من حسابك وجهازك. إذا كان هذا جهازًا جديدًا، سنقترح تفويضًا بقيمة 1€.",
    CANCEL: "إلغاء",
    CONTINUE: "متابعة",
    REVOKE_HINT:
...
export default function ConnectModal() {
  ...
  async function connectKnown() {
    // marquer “connecté” sans rien toucher aux plans
    try {
  ...
  async function onAuthorizeOneEuro() {
    try {
      ...
      // si PayPal ouvre puis revient → le webhook confirmera
      // (au retour, tu peux aussi écouter un paramètre de callback pour UI)
    } catch (e: any) {
